...
$sanitized_attributes = Hello_World_Config::sanitize_attributes($attributes);
...
error_log('[CM Hello World] Custom padding: ' . print_r($custom_padding, true));
var_dump($custom_padding);
// Build wrapper classes using centralized processor (now includes container classes)
$wrapper_classes = Hello_World_Config::get_enhanced_wrapper_classes(
...
$inline_styles = Hello_World_Config::build_global_css_properties($sanitized_attributes);
...
<div class="<?php echo esc_attr($wrapper_classes); ?>" 
     ...
     <?php endif; ?>
     data-block="hello-world">
    
    <p class="hello-world-content">
