(function() {
    ...
    let CONFIG = window.HelloWorldConfig;
    ...
    function BlockEdit({ attributes, setAttributes }) {
        ...
        if (processedAttributes.isExample) {
            return createElement('img', {
                src: '/wp-content/themes/word4ya/cm-blocks/hello-world/preview.png',
        ...
        return createElement(Fragment, null, [
            ...
            createElement('div', {
                key: 'content',
                ...blockProps,
                className: `${blockProps.className} hello-world cm-cqi-container zc95 zo95 zm95 zp95 zu95 zt95 ze95`,
                style: generateBlockStyles()
            }, [
                createElement(RichText, {
                    key: 'hello-world-content',
                    tagName: 'p',
                    className: 'hello-world-content',
                    value: processedAttributes.message,
                    onChange: (value) => updateAttribute('message', value),
                    placeholder: __('Type your message here...', 'hello_world')
                })
            ])
        ]);
    }
