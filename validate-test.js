...
// Read the existing generated block files
const blockDir = './output/cm-pricing-table';
const testBlock = {
...
console.log('🔍 TESTING SSOT VALIDATION SYSTEM');
console.log('==================================');
console.log('');
console.log('Testing existing cm-pricing-table block against SSOT requirements...');
console.log('');
...
try {
  ...
  console.log('');
  console.log('✅ Validation completed - check output above for compliance issues');
} catch (error) {
